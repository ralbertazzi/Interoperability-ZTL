...
public class SSAP_XMLTools
{
	...
	for(int i=0; i<hashtable.size();i++)
		if(!ref[i].equals( (String)hashtable.get(id[i]) )) return false;
	...
	public final static String WQL_VALUES="WQL-VALUES";
	public final static String WQL_RELATED="WQL-RELATED";
	public final static String WQL_NODETYPES="WQL-NODETYPES";
	public final static String WQL_ISTYPE="WQL-ISTYPE";
	public final static String WQL_ISSUBTYPE="WQL-ISSUBTYPE";
